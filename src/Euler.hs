...
problem12 = (head . unzipT . dropWhile ((<= 500) . snd) . zipT numDivisors) triangleNumbers
...
problem30 =
    let nums = [2..355000]
     ...
     in (sum . unzipT . filter equalT . zipT pow) nums
...
problem34 = (sum . unzipT . filter equalT . zipT sumDigitFactorial) [3..2540160]

-- | Solves <https://projecteuler.net/problem=35 Project Euler Problem #35>
problem35 = (length . filter f) (primesTo 999999)
  where
...
problem67 =
  let pyr = [ [59]
            ...
            , [33, 24, 47, 61, 60, 55, 32, 88, 57, 55, 91, 54, 46, 57,  7, 77, 98, 52, 80, 99, 24, 25, 46, 78, 79, 05]
            ...
            , [92, 48, 22, 99, 15, 95, 64, 43,  1, 16, 94,  2, 99, 19, 17, 69, 11, 58, 97, 56, 89, 31, 77, 45, 67, 96, 12, 73,  8, 20, 36, 47, 81, 44, 50, 64, 68, 85, 40, 81, 85, 52, 09]
            , [91, 35, 92, 45, 32, 84, 62, 15, 19, 64, 21, 66,  6,  1, 52, 80, 62, 59, 12, 25, 88, 28, 91, 50, 40, 16, 22, 99, 92, 79, 87, 51, 21, 77, 74, 77,  7, 42, 38, 42, 74, 83,  2, 05]
            ...
            , [73, 26, 21, 44, 46, 38, 17, 83, 65, 98,  7, 23, 52, 46, 61, 97, 33, 13, 60, 31, 70, 15, 36, 77, 31, 58, 56, 93, 75, 68, 21, 36, 69, 53, 90, 75, 25, 82, 39, 50, 65, 94, 29, 30, 11, 33, 11, 13, 96,  2, 56, 47,  7, 49, 02]
            ...
            , [ 3, 14, 80, 27, 22, 30, 44, 27, 67, 75, 79, 32, 51, 54, 81, 29, 65, 14, 19,  4, 13, 82,  4, 91, 43, 40, 12, 52, 29, 99,  7, 76, 60, 25,  1,  7, 61, 71, 37, 92, 40, 47, 99, 66, 57,  1, 43, 44, 22, 40, 53, 53,  9, 69, 26, 81, 07]
            ...
            , [47, 81, 28,  9, 98, 51, 67, 64, 35, 51, 59, 36, 92, 82, 77, 65, 80, 24, 72, 53, 22,  7, 27, 10, 21, 28, 30, 22, 48, 82, 80, 48, 56, 20, 14, 43, 18, 25, 50, 95, 90, 31, 77,  8,  9, 48, 44, 80, 90, 22, 93, 45, 82, 17, 13, 96, 25, 26,  8, 73, 34, 99,  6, 49, 24,  6, 83, 51, 40, 14, 15, 10, 25, 01]
            ...
            , [19, 23, 61, 36,  9, 89, 71, 98, 65, 17, 30, 29, 89, 26, 79, 74, 94, 11, 44, 48, 97, 54, 81, 55, 39, 66, 69, 45, 28, 47, 13, 86, 15, 76, 74, 70, 84, 32, 36, 33, 79, 20, 78, 14, 41, 47, 89, 28, 81,  5, 99, 66, 81, 86, 38, 26,  6, 25, 13, 60, 54, 55, 23, 53, 27,  5, 89, 25, 23, 11, 13, 54, 59, 54, 56, 34, 16, 24, 53, 44, 06]
            ...
            , [54, 96, 80, 15, 91, 90, 99, 70, 10,  9, 58, 90, 93, 50, 81, 99, 54, 38, 36, 10, 30, 11, 35, 84, 16, 45, 82, 18, 11, 97, 36, 43, 96, 79, 97, 65, 40, 48, 23, 19, 17, 31, 64, 52, 65, 65, 37, 32, 65, 76, 99, 79, 34, 65, 79, 27, 55, 33,  3,  1, 33, 27, 61, 28, 66,  8,  4, 70, 49, 46, 48, 83,  1, 45, 19, 96, 13, 81, 14, 21, 31, 79, 93, 85, 50, 05]
            ...
            , [60, 85, 59, 39, 60,  7, 57, 76, 77, 92,  6, 35, 15, 72, 23, 41, 45, 52, 95, 18, 64, 79, 86, 53, 56, 31, 69, 11, 91, 31, 84, 50, 44, 82, 22, 81, 41, 40, 30, 42, 30, 91, 48, 94, 74, 76, 64, 58, 74, 25, 96, 57, 14, 19,  3, 99, 28, 83, 15, 75, 99,  1, 89, 85, 79, 50,  3, 95, 32, 67, 44,  8,  7, 41, 62, 64, 29, 20, 14, 76, 26, 55, 48, 71, 69, 66, 19, 72, 44, 25, 14,  1, 48, 74, 12, 98, 07]
...
-- | Solves <https://projecteuler.net/problem=69 Project Euler Problem #69>
problem69 = product $ unfoldr f (1,2)
  where
    f (memo, n)
      | memo * n <= 1000000 = Just (n, (memo * n, nextPrime n))
      | otherwise = Nothing
