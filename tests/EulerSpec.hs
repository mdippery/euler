...
spec = do
  ...
  describe "Verify that problem 27" $ do
    it "is correct" $ do
      problem27 `shouldBe` (-59231)
  ...
  describe "Verify that problem 33" $ do
    it "is correct" $ do
      problem33 `shouldBe` 100
  ...
  describe "Verify that problem 43" $ do
    it "is correct" $ do
      problem43 `shouldBe` 16695334890
